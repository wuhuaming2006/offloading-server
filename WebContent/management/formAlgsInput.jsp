		...
		<div id="container">
			...
			<div id="content">
				...
				<ul>
					...
					<li>You must define a function to summarize any input case to a single (as small as possible while representative) numeric value (it will be parsed as a Java Long, so take into account its range limitations), and for every line add the corresponding numeric representation as the first element.</li>
